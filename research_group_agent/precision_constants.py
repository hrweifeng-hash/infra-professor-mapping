...
CURRENT_SECTION_KEYWORDS: dict[str, MemberRole] = {
    ...
    "research team": MemberRole.UNKNOWN,
    "people directory": MemberRole.UNKNOWN,
    "student directory": MemberRole.UNKNOWN,
    "affiliated students": MemberRole.PHD_STUDENT,
    "visitors": MemberRole.VISITOR,
    "visitor": MemberRole.VISITOR,
...
ALUMNI_SECTION_KEYWORDS: dict[str, MemberRole] = {
    ...
    "affiliated alumni": MemberRole.ALUMNI,
